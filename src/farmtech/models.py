...
class Experiment1Sheet2(gis_models.Model):
    ...
    ogc_fid = models.AutoField(primary_key=True, name='ogc_fid')
    year = models.IntegerField(null=True, blank=True, name='year')
    cover_crop_systems = models.CharField(max_length=200, null=True,
                                          blank=True, name='cover_crop_systems')
    biomass_cover_crop = models.FloatField(null=True, blank=True, name='biomass_cover_crop_(t/ha)')
...
class Experiment1Sheet3(gis_models.Model):
    ...
    ogc_fid = models.AutoField(primary_key=True, name='ogc_fid')
    year = models.IntegerField(null=True, blank=True, name='year')
    cover_crop_species = models.CharField(max_length=200,
                                          null=True, blank=True, name='cover_crop_species')
    type_cover_termination = models.CharField(max_length=200, null=True,
                                              blank=True, name='type_of_cover_termination')
    tomato_yield = models.FloatField(null=True, blank=True, name='tomato_yield_(kg/plant)')
    geometry = gis_models.GeometryField(srid=4326, null=True, blank=True, name='geometry')
...
class Experiment4(gis_models.Model):
    ...
    produzione_kg_pianta = models.FloatField(null=True, blank=True, name='produzione_kg/pianta')
    biomassa_g_pianta = models.FloatField(null=True, blank=True, name='biomassa_g/pianta')
    ...
    nitrato_riduttasi_nr = models.FloatField(null=True, blank=True,
                                             name='nitrato_riduttasi_(nr)')
    glutammina_sintetasi_gs = models.FloatField(null=True,
                                                blank=True, name='glutammina_sintetasi_(gs)')
    glutammato_gogat = models.FloatField(null=True, blank=True, name='glutammato_(gogat)')
...
class ExperimentZootechnicalCalabria(gis_models.Model):
    ...
    cereali = models.FloatField(null=True, blank=True,
                                name='cereali_[loietto]_(peso_secco_[kg_m_2])')
    leguminose = models.FloatField(null=True, blank=True,
                                   name='leguminose_[trifoglio_bianco]_(peso_secco_[kg_m_2])')
    altro = models.FloatField(null=True, blank=True,
                              name='altro_[crucifere_e_brassicacee]_(peso_secco_[kg_m_2])')
    peso_totale = models.FloatField(null=True, blank=True, name='peso_totale_(peso_secco_[kg_m_2])')
    ...
    inizio_pascolamento = models.DateField(null=True, blank=True, name='inizio_pascolamento')
...
class ExperimentZootechnicalBasilicata(gis_models.Model):
    ...
    temperatura_suolo_c = models.FloatField(null=True, blank=True, name='temperatura_suolo_°c')
    umidita_suolo_percent = models.FloatField(null=True, blank=True, name='umidità_suolo_%')
    altezza_pascolo_cm = models.FloatField(null=True, blank=True, name='altezza_pascolo_cm')
    temperatura_aria_c = models.FloatField(null=True, blank=True, name='temperatura_aria_°c')
    ...
    biomassa_secca_totale = models.FloatField(null=True, blank=True,
                                              name='biomassa_secca_totale_(g/0,25_mq)')
    biomassa_secca_pulita = models.FloatField(null=True, blank=True,
                                              name='biomassa_secca_pulita_dal_secco_(g/_0,25_mq)')
    percent_ss_campione_verde = models.FloatField(null=True, blank=True, name='%_ss_campione_verde')
    percent_ss_campione_pulito = models.FloatField(null=True, blank=True,
                                                   name='%_ss_campione_pulito')
    peso_graminacee_g = models.FloatField(null=True, blank=True, name='peso_graminacee_(g)')
    peso_leguminose_g = models.FloatField(null=True, blank=True, name='peso_leguminose_(g)')
    peso_composite_g = models.FloatField(null=True, blank=True, name='peso_composite_(g)')
    ...
    proteine_nir_unibas = models.FloatField(null=True, blank=True, name='proteine_nir_unibas')
    ...
    proteine_ara_kjeldhal = models.FloatField(null=True, blank=True, name='protenine_ara_kjeldhal')
    grassi_ss_ara = models.FloatField(null=True, blank=True, name='grassi_ss_ara')
    estratto_etereo_percent_nir_unibas = models.FloatField(null=True, blank=True,
                                                           name='estratto_etereo_%_nir_unibas')
    ...
    ceneri_percent_nir_unibas = models.FloatField(null=True, blank=True, name='ceneri_%_nir_unibas')
    ...
    famiglia_nir = models.CharField(max_length=255, null=True, blank=True, name='famiglia_nir')
